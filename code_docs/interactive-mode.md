...
Title: 交互模式 - Claude Code Docs

URL Source: https://code.claude.com/docs/zh-CN/interactive-mode
...
| `Tab` | 切换 [扩展思考](https://docs.claude.com/zh-CN/docs/build-with-claude/extended-thinking) | 在思考开启和思考关闭之间切换 |
...
| `/` 在开始 | 斜杠命令 | 参见 [斜杠命令](https://code.claude.com/docs/zh-CN/slash-commands) |
...
*   [斜杠命令](https://code.claude.com/docs/zh-CN/slash-commands) - 交互式会话命令
*   [检查点](https://code.claude.com/docs/zh-CN/checkpointing) - 回退 Claude 的编辑并恢复以前的状态
